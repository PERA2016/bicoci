...
function wpds_check_thumbnail($post_id) {
    ...
    if(get_post_type($post_id) != 'libro')
        return;
...
function wpds_thumbnail_error($post_id)
{
    ...
    if ( get_transient( "has_post_thumbnail" ) == "no" ) {
        echo "<div id='msjDestacada1' class='error'><p><strong>* Debes establecer una Imagen Destacada, para publicar el Libro: ".$titulo.".</strong></p>
